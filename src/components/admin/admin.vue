        ...
        :collapse="isCollapse">
          ...
          <el-submenu index="4">
            <template slot="title"><i class="el-icon-menu"></i><span slot="title">其他内容</span></template>
              ...
              <el-menu-item @click.native="$router.push('/admin/demo/publish')" index="4-2">Demo上传</el-menu-item>
              <el-menu-item @click.native="$router.push('/admin/tool/publish')" index="4-3">素材&工具</el-menu-item>
          </el-submenu>
          <el-submenu index="5">
